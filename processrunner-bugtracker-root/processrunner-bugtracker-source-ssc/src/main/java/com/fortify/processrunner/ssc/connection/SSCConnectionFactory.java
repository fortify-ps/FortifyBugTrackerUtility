...
public final class SSCConnectionFactory 
{
	public static final void addContextProperties(Collection<ContextProperty> contextProperties, Context context) {
		contextProperties.add(new ContextProperty(IContextSSC.PRP_SSC_BASE_URL, "SSC base URL", context,  "Read from console", false));
		contextProperties.add(new ContextProperty(IContextSSC.PRP_SSC_USER_NAME, "SSC user name", context, "Read from console", false));
		contextProperties.add(new ContextProperty(IContextSSC.PRP_SSC_PASSWORD, "SSC password", context, "Read from console", false));
		contextProperties.add(new ContextProperty(IContextSSC.PRP_SSC_AUTH_TOKEN, "SSC auth token", context, "Read from console", false));
